...
?>
				<div class="div_button">
					<form action="action_page.php" method="post">
						<button type="submit" class="button_green" name="cancelBooking_confirm_admin" >CONFIRM</button>						
						<button type="submit" class="button_red" name="cancelBooking_cancel_admin">CANCEL</button>						
					</form>
				</div>
			</section>
			</article>
