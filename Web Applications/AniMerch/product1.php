...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Fate/Stay Night Collab">
		<meta name="keywords" content="Fate/Stay Night: Heaven's Feel, Collab">
		<script src="script/script.js"></script>
		<script src="script/enhancement.js"></script>
		<title>Fate/Stay Night: Heaven's Feel Collaboration</title>
	</head>
		...
		<article>
			...
			<?php
				...
				if ($conn)
				{
					...
					FROM productTable WHERE category='1'";
